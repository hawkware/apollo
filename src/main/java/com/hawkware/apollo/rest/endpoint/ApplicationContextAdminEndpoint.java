...
import com.hawkware.apollo.rest.resources.ApplicationContextResource;
...
public class ApplicationContextAdminEndpoint {
	...
	if (ctx != null) {
	    ...
	    ApplicationContextResource appCtxResource = new ApplicationContextResource(ctx.getName(), serverResources);
